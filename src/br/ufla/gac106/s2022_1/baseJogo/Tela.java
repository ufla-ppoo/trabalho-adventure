  ...
  public void jogadorPegouItem(EntidadeGrafica item) {
    ...
    if (quantidade == 0) {
      ...
      if (imagem != null) {
        ...
        rotuloImagemItem =
          new JLabel(new ImageIcon(redimensionarImagem(imagem, false)));
      } else {
        // se a imagem não foi carregada informa isso na tela
      ...
      if (quantidade == 1) {
        ...
        rotuloNomeItem.setText(
          rotuloNomeItem
            .getText()
            .substring(0, rotuloNomeItem.getText().lastIndexOf("(")) +
          "(x" +
          (quantidade + 1) +
          ")"
        );
    ...
    if (rotuloItem == null) {
      ...
      if (rotuloNomeItem.getText().equals(item.getNome())) {
        ...
        return Integer.parseInt(
          rotuloNomeItem
            .getText()
            .substring(indiceAbreParenteses + 2, indiceFechaParenteses)
        );
      }
    }
  }
